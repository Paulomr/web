/* =====================================================================
   BOOTSTRAP: crea Phaser (Matter), conecta UI y desbloqueo de audio.
   Aqui (y solo aqui) se traducen eventos ui:* a operaciones de escena,
   para no registrar listeners duplicados dentro de la escena.
   ===================================================================== */
...
const game=new Phaser.Game({
  ...
  physics: { default:'matter', matter:{ gravity:{y:GRAVITY_Y}, enableSleeping:false, debug:false } },
