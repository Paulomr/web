 ...
 *
 * `maxToppings` = cuántos toppings distintos puede llevar como mucho una galleta
 * ese día. Debajo siempre va 1 sola crema. El día 1 se queda en 2 para que la
 * galleta se lea limpia mientras se aprende. */

export const DIAS = [
  {
    dia: 1, maxToppings: 2, duracionS: 90, pedidosMax: 6, clientesSimultaneos: 1, spawnIntervaloS: 1.2,
  ...
  {
    dia: 2, maxToppings: 2, duracionS: 90, pedidosMax: 8, clientesSimultaneos: 2, spawnIntervaloS: 9,
  ...
  {
    dia: 3, maxToppings: 2, duracionS: 100, pedidosMax: 9, clientesSimultaneos: 2, spawnIntervaloS: 8.5,
  ...
  {
    dia: 4, maxToppings: 3, duracionS: 110, pedidosMax: 11, clientesSimultaneos: 3, spawnIntervaloS: 7.5,
  ...
  {
    dia: 5, maxToppings: 3, duracionS: 120, pedidosMax: 13, clientesSimultaneos: 3, spawnIntervaloS: 6.5,
...
export const HORA_PICO = {
  ...
  ventanaPerfectaS: 1.8, probVip: 0.1, hornoPuestos: 3, itemsPorPedido: [1, 2], maxToppings: 3,
};
